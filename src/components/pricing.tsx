            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 p-8 flex flex-col hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors"
                    >
                    ...
                    <motion.div
                        ...
                        className="rounded-3xl border-2 border-indigo-500 bg-white dark:bg-neutral-900/80 p-8 flex flex-col relative overflow-hidden shadow-2xl shadow-indigo-500/20"
                    >
